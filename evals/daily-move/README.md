...
`QDM-A01` includes both the literal historical mistake and equivalent invented architectures. The CI contract is armed before implementation exists: once any Daily Move Program, Skill, or evaluator appears, the validator requires the implementation to execute every fixture. An implementation that accepts any `QDM-A01` attempt fails conformance.
