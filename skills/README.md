...
| `quirk-intent-shaper` | personalize | propose | reversible Intent × Persona × Affect × Affordance plan |
...
No skill may self-activate, increase its own authority, promote Canon, rewrite history, update user settings, persist an inferred preference, or perform an irreversible write merely because the capability or credentials exist or without an external grant and admission evidence.
